...
![](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/synchronized%E5%85%B3%E9%94%AE%E5%AD%97.png)
...
![synchronized关键字原理](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/synchronized%E5%85%B3%E9%94%AE%E5%AD%97%E5%8E%9F%E7%90%86.png)
...
![synchronized关键字原理](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/synchronized%E5%85%B3%E9%94%AE%E5%AD%97%E5%8E%9F%E7%90%862.png)
...
![CPU Cache](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/303a300f-70dd-4ee1-9974-3f33affc6574.png)
...
![JMM(Java内存模型)](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/0ac7e663-7db8-4b95-8d8e-7d2b179f67e8.png)

要解决这个问题，就需要把变量声明为 **`volatile`** ，这就指示 JVM，这个变量是共享且不稳定的，每次使用它都到主存中进行读取。

所以，**`volatile` 关键字 除了防止 JVM 的指令重排 ，还有一个重要的作用就是保证变量的可见性。**

![volatile关键字的可见性](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/d49c5557-140b-4abf-adad-8aac3c9036cf.png)

### 2.3. 并发编程的三个重要特性

1. **原子性** : 一个的操作或者多次操作，要么所有的操作全部都得到执行并且不会收到任何因素的干扰而中断，要么所有的操作都执行，要么都不执行。`synchronized` 可以保证代码片段的原子性。
1. **可见性** ：当一个变量对共享变量进行了修改，那么另外的线程都是立即可以看到修改后的最新值。`volatile` 关键字可以保证共享变量的可见性。
1. **有序性** ：代码在执行的过程中的先后顺序，Java 在编译器以及运行期间的优化，代码的执行顺序未必就是编写代码时候的顺序。`volatile` 关键字可以禁止指令进行重排序优化。
...
![ThreadLocal数据结构](/Users/mbpzy/Downloads/JavaGuide/docs/java/multi-thread/images/threadlocal%25E6%2595%25B0%25E6%258D%25AE%25E7%25BB%2593%25E6%259E%2584.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](/Users/mbpzy/Downloads/JavaGuide/docs/java/multi-thread/images/ThreadLocal%25E5%2586%2585%25E9%2583%25A8%25E7%25B1%25BB.png)
...
![ThreadPoolExecutor构造方法](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/ThreadPoolExecutor%E6%9E%84%E9%80%A0%E6%96%B9%E6%B3%95.png)
...
![Executor框架的工具类](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/Executor%E6%A1%86%E6%9E%B6%E7%9A%84%E5%B7%A5%E5%85%B7%E7%B1%BB.png)
...
![图解线程池实现原理](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/%E5%9B%BE%E8%A7%A3%E7%BA%BF%E7%A8%8B%E6%B1%A0%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86.png)
...
![JUC原子类概览](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/JUC%E5%8E%9F%E5%AD%90%E7%B1%BB%E6%A6%82%E8%A7%88.png)
...
![AQS类](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/AQS%E7%B1%BB.png)
...
![AQS原理图](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/AQS%E5%8E%9F%E7%90%86%E5%9B%BE.png)
...
1. 将 AQS 组合在自定义同步组件的实现中，并调用其模板方法，而这些模板方法会调用使用者重写的方法。
