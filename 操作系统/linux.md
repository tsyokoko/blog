...
![](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/image-20200807161118901.png)
...
![Kernel_Layout](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/Kernel_Layout.png)
...
![windows](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/windows.png)
...
![unix](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/unix.png)
...
![linux](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/linux.png)

#### 1.2.4. Mac OS

苹果自家的操作系统，编程体验和 Linux 相当，但是界面、软件生态以及用户体验各方面都要比 Linux 操作系统更好。

![macos](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/macos.png)
...
1. **操作系统的内核（Kernel）是操作系统的核心部分，它负责系统的内存管理，硬件设备的管理，文件系统的管理以及应用程序的管理。**
1. **操作系统的内核是连接应用程序和硬件的桥梁，决定着操作系统的性能和稳定性。**
...
1. **CPU 主要包括两个部分：控制器+运算器。**
1. **CPU 的根本任务就是执行指令，对计算机来说最终都是一串由“0”和“1”组成的序列。**
...
1. **系统态(kernel mode)**: 可以简单的理解系统态运行的进程或程序几乎可以访问计算机的任何资源，不受限制。
...
![](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/L181kk2Eou-compress.jpg)
...
![Linux](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/Linux%25E4%25B9%258B%25E7%2588%25B6.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/Linux-Logo.png)
...
![文件inode信息](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/%25E6%2596%2587%25E4%25BB%25B6inode%25E4%25BF%25A1%25E6%2581%25AF.png)
...
![Linux的目录结构](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/Linux%25E7%259B%25AE%25E5%25BD%2595%25E6%25A0%2591.png)
...
![](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/Linux%25E6%259D%2583%25E9%2599%2590%25E5%2591%25BD%25E4%25BB%25A4.png)

第一列的内容的信息解释如下：

![](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/Linux%25E6%259D%2583%25E9%2599%2590%25E8%25A7%25A3%25E8%25AF%25BB.png)
...
![](/Users/mbpzy/Downloads/JavaGuide/docs/operating-system/images/%25E4%25BF%25AE%25E6%2594%25B9%25E6%2596%2587%25E4%25BB%25B6%25E6%259D%2583%25E9%2599%2590.png)
...
1. 新建一个脚本 zookeeper
1. 为新建的脚本 zookeeper 添加可执行权限，命令是:`chmod +x zookeeper`
1. 把 zookeeper 这个脚本添加到开机启动项里面，命令是：`chkconfig --add zookeeper`
1. 如果想看看是否添加成功，命令是：`chkconfig --list`
...
![我的公众号](https://tsyokoko-typora-images.oss-cn-shanghai.aliyuncs.com/img/167598cd2e17b8ec.png)
